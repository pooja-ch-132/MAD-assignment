        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
                    joinDate = LocalDate.parse(doj, DateTimeFormatter.ofPattern("d-M-yyyy"));
                }
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
                    if (joinDate.isAfter(currentDate)) {
                        Toast.makeText(MainActivity.this, "Date of joining can't be in the future", Toast.LENGTH_SHORT).show();
                        return;
                    }
                }
